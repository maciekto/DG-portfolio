        ...
        <div className="MyWorks">
            ...
            <div className='MyWorks-Sections'>
                ...
                <div className={`MyWorks-Sections-Works ${width > 1366 ? null : Visualizations}`}>
                    <img src={MyWorks_1} className={width > 1366 ? null : VisualizationsImg}/>
                    <img src={MyWorks_2} className={width > 1366 ? null : VisualizationsImg}/>
                </div>
                ...
                <div className={`MyWorks-Sections-Works ${width > 1366 ? null : Banner}`}>
                    <img src={MyWorks_3} className={width > 1366 ? null : BannerImg}/>
                    <img src={MyWorks_4} className={width > 1366 ? null : BannerImg}/>
                    <img src={MyWorks_5} className={width > 1366 ? null : BannerImg}/>
                </div>
                ...
                <div className={`MyWorks-Sections-Works ${width > 1366 ? null : Drawings}`}>
                    <img src={MyWorks_6} className={width > 1366 ? null : DrawingsImg}/>
                    <img src={MyWorks_7} className={width > 1366 ? null : DrawingsImg}/>
                    <img src={MyWorks_8} className={width > 1366 ? null : DrawingsImg}/>
                </div>
            </div>
        </div>
    )
