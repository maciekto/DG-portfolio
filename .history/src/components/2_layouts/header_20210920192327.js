        ...
        return (
            <header>
                ...
                <div className='header-Title'>
                    Art is <span className='header-Title-PinElipseTitle'>not<img src={this.state.width < 768 ? elipse_title : elipse_titlePC} alt='Elipse' className='header-Title-ImgElipseTitle' /></span> a thing,<br />
                    it is a way 
                    <br />
                    <span className='header-Title-Quote'>Elbert Hubbard</span>
                </div>
                <img src={this.state.width < 768 ? laptop : laptopPC} alt='Laptop' className='header-Laptop' />
            </header>
        )
    }
}
