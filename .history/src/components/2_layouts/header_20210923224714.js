    ...
    return (
        <header>
                ...
                <div className='header-Title'>
                    Art&nbsp;is&nbsp;<span className='header-Title-PinElipseTitle'>not<img src={width < 1366 ? elipse_title : elipse_titlePC} alt='Elipse' className='header-Title-ImgElipseTitle' /></span> a <span className="header-Title-LaptopPC">thing,{width >= 1366 ? <img src={laptopPC} alt='Laptop' className='header-LaptopPC' /> : null} </span><br />
                    it is a way 
                    <br />
                    <span className='header-Title-Quote'>Elbert Hubbard</span>
                </div>
                {width < 1366 ? <img src={laptop} alt='Laptop' className='header-Laptop' /> : null}
