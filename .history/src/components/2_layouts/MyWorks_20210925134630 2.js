...
export default function MyWorks() {
    ...
    const [BannerArrow, setBannerArrow] = useState('MyWorks-Sections-Title-Arrow-Banner_off_img');
    ...
    const clickSection = (type) => {
        if(type === 'Visualizations') {
            ...
            BannerImg === 'MyWorks-Sections-Title-Arrow-Banner_off_img' ? setBannerArrow('') : setBannerArrow('MyWorks-Sections-Title-Arrow-Banner_off_img');
        }
