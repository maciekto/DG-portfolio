    ...
    return (
        <header>
                ...
                <div className='header-Title'>
                    Art&nbsp;is&nbsp;<span className='header-Title-PinElipseTitle'>not<img src={width < 1366 ? elipse_title : elipse_titlePC} alt='Elipse' className='header-Title-ImgElipseTitle' /></span> a <span className="header-Title-LaptopPC">thing, <img src={width < 1366 ? laptop : null} alt='Laptop' className='header-LaptopPC' /></span><br />
                    it is a way 
                    <br />
                    <span className='header-Title-Quote'>Elbert Hubbard</span>
                </div>
                <img src={width < 1366 ? laptop : null} alt='Laptop' className='header-Laptop' />
            </header>
    )
}
