...
export default function MyWorks() {
    ...
    const [Banner, setVisualizations] = useState('MyWorks-Sections-Works-Banner');
    const [BannerArrow, setVisualizationsArrow] = useState('MyWorks-Sections-Title-Arrow-Banner_off');
