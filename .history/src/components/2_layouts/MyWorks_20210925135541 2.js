    ...
    return (
        <div className="MyWorks">
            ...
            <div className='MyWorks-Sections'>
                <div className='MyWorks-Sections-Visualization-Title' onClick={() => clickSection('Visualizations')}>
                    Visualizations
                ...
                <div className='MyWorks-Sections-Banners-Title' onClick={() => clickSection('Banners')}>
                    Banner
