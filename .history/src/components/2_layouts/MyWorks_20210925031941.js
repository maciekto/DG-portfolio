...
export default function MyWorks() {
    ...
    const clickSection = (type) => {
        if(type === 'Visualizations') {
            Visualizations === 'MyWorks-Sections-Works-Visualizations_off' ? setVisualizations('') : setVisualizations('MyWorks-Sections-Works_off');
            VisualizationsArrow === 'MyWorks-Sections-Title-Arrow-Visualizations_off' ? setVisualizationsArrow('') : setVisualizationsArrow('MyWorks-Sections-Title-Arrow_off');
